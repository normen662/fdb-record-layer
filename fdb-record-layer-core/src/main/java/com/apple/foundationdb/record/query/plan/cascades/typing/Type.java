...
public interface Type extends Narrowable<Type> {
    ...
    class Array implements Type {
        ...
        /**
         * Returns <code>true</code> if a nested protobuf message is required for the array element type, otherwise
         * <code>false</code>.
         *
         * @return <code>true</code> if a nested protobuf message is required for the array element type, otherwise
         * <code>false</code>.
         */
        ...
        /**
         * Returns <code>true</code> if a nested protobuf message is required for the given type, otherwise
         * <code>false</code>.
         *
