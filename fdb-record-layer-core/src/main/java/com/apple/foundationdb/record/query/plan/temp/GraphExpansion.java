...
public class GraphExpansion implements KeyExpressionVisitor.Result {
    ...
    @Nonnull
    public static GraphExpansion ofResultValueAndPredicate(@Nonnull final Value resultValue, @Nonnull final QueryPredicate predicate) {
        return new GraphExpansion(ImmutableList.of(), ImmutableList.of(predicate), ImmutableList.of(), ImmutableList.of());
    }
    ...
    public static GraphExpansion ofQuantifier(@Nonnull final Quantifier quantifier) {
        return new GraphExpansion(ImmutableList.of(), ImmutableList.of(), ImmutableList.of(quantifier), ImmutableList.of());
    }
    ...
    public static GraphExpansion ofPlaceholderAndQuantifier(@Nonnull final Placeholder placeholder, @Nonnull final Quantifier quantifier) {
        return new GraphExpansion(ImmutableList.of(), ImmutableList.of(placeholder), ImmutableList.of(quantifier), ImmutableList.of(placeholder));
    }

    @Nonnull
    public static GraphExpansion ofOthers(@Nonnull GraphExpansion... expandedPredicates) {
