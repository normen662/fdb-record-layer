...
public class MatchableSortExpression implements RelationalExpressionWithChildren, InternalPlannerGraphRewritable {
    ...
    public MatchableSortExpression(@Nonnull final List<CorrelationIdentifier> sortParameterIds,
        ...
        this(sortParameterIds, isReverse, Quantifier.forEach(GroupExpressionRef.of(innerExpression)));
    }
    ...
    @Nonnull
    @Override
    public Optional<MatchInfo> adjustMatch(@Nonnull final RelationalExpression expression, @Nonnull final PartialMatch partialMatch) {
